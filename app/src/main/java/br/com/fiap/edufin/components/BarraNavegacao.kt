...
fun BarraNavegacao(
    ...
    NavigationBar(
        ...
        ItemNavegacao(
            ...
            rotulo = stringResource(id = R.string.nav_debts),
        ...
        ItemNavegacao(
            ...
            rotulo = stringResource(id = R.string.nav_invest),
            selecionado = rotaAtual == Rota.SimuladorInvestimentos.caminho,
            aoClicar = {
                aoNavegar(Rota.SimuladorInvestimentos)
            }
        )
